...
OPEN_GPIB_ADD_CMD(SERIAL_CMD_SET_CHAR_TIMEOUT,"interchar_timeout",50000)
OPEN_GPIB_ADD_CMD(SERIAL_CMD_SET_BAUD,"baud_rate",115200)
OPEN_GPIB_ADD_CMD(SERIAL_CMD_SET_PARITY,"parity",'N')
OPEN_GPIB_ADD_CMD(SERIAL_CMD_SET_DATA_BITS,"data_bits",8)
OPEN_GPIB_ADD_CMD(SERIAL_CMD_SET_STOP, "stop_bits",1)
OPEN_GPIB_ADD_CMD(SERIAL_CMD_SET_FLOW,"flow_control",'N')
